...
{
  public class WelcomeScreen : UserControl, IComponentConnector
  {
    ...
    {
      if (isAlive)
        Task.Run((Action) (() => this.AuthorizeFromSettings()));
      else
    ...
    public void InitializeComponent()
    {
      ...
      Application.LoadComponent((object) this, new Uri("/SMClient;component/controls/windows/welcomescreen.xaml", UriKind.Relative));
    }
