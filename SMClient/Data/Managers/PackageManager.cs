...
namespace SMClient.Data.Managers
{
  public static class PackageManager
  {
    ...
    public static void ReUnpackStaticArchives()
    {
      IEnumerable<Package> packages = PackageManager.Packages.Where<Package>((Func<Package, bool>) (x => x.IsStatic));
      PrepareManager.RemoveStaticData();
      foreach (Package package in packages)
        ArchiveManager.UnpackStaticWithDeps(package);
    }
